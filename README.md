...
> [!CAUTION]  
> Be careful when running any unaudited scripts. These are my personal configurations and there might be some configurations which you may not need or like. I suggest to pick and choose only the packages you would want to install.
